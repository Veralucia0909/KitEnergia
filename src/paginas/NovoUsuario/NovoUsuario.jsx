...
//       toast.error("A senha deve conter no mínimo 4 caracteres."); return;
//     }
//     if (usuarioForm.senha !== usuarioForm.confirmacaoSenha) {
//       toast.error("As senhas não coincidem."); return;
//     }
//      // Valida unidade selecionada
//     if (!usuarioForm.unidade) {
//       toast.error("Selecione sua unidade.");
//       return;
//     }
//     if (usuarioForm.perfil === "inquilino" && !usuarioForm.unidade) {
//       toast.error("Selecione a unidade (kit) do inquilino."); return;
//     }
...
//       <CampoCustomizado label="Nome" value={usuarioForm.nome}
//         onChange={(e) => setUsuarioForm({ ...usuarioForm, nome: e.target.value })} obrigatorio />

//       <CampoCustomizado label="Email" type="email" value={usuarioForm.email}
//         onChange={(e) => setUsuarioForm({ ...usuarioForm, email: e.target.value })}
//         onBlur={(e) => { if (!validarEmail(e.target.value)) toast.error("Email inválido."); }}
//         obrigatorio />

//       <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
//         <CampoCustomizado label="Senha" type="password" value={usuarioForm.senha}
...
//       <CampoCustomizado label="Confirmação da Senha" type="password" value={usuarioForm.confirmacaoSenha}
//         onChange={(e) => setUsuarioForm({ ...usuarioForm, confirmacaoSenha: e.target.value })} obrigatorio />
...
//           <option>Kit 1</option><option>Kit 2</option><option>Kit 3</option>
//           <option>Kit 4</option><option>Kit 5</option><option>Kit 6</option>
//           <option>Kit 7</option><option>Kit 8</option><option>Kit 9</option>
//           <option>Kit 10</option><option>Kit 11</option><option>Kit 12</option>
//         </select>
//       </div>

//       {usuarioForm.perfil === "inquilino" && (
//         <div className="campo-customizado__root">
//           <span>Sua Unidade (Kit) *</span>
//           <select className="campo-customizado__input" value={usuarioForm.unidade}
//             onChange={(e) => setUsuarioForm({ ...usuarioForm, unidade: e.target.value })}>
//             <option value="">Selecione o kit...</option>
...
//       <BotaoCustomizado tipo="secundario" aoClicar={salvar}>Salvar</BotaoCustomizado>
//     </Principal>
//   );
// }
